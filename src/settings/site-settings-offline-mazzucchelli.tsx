...
export const siteSettingsData = {
  ...
  site_header: {
    menu: [
      {
        id: 1,
        path: "https://mazzucchellis.com.au/collections/jewellery",
        label: "JEWELLERY",
        columns: [
          {
            id: 2,
      ...
      {
        id: 2,
        path: "https://mazzucchellis.com.au/collections/diamonds",
        label: "DiAMONDS",
        columns: [
          {
            id: 1,
      ...
      {
        id: 4,
        path: "https://mazzucchellis.com.au/collections/all-premium-brands",
        label: "PREMIUM BRAND",
        subMenu: [
          {
            id: 1,
      ...
      {
        id: 5,
        path: "https://mazzucchellis.com.au/collections/watches",
        label: "WATCHES",
        subMenu: [
          {
            id: 1,
      ...
      {
        id: 6,
        path: "https://mazzucchellis.com.au/collections/sale",
        label: "SALE"
      },
      {
        id: 7,
        path: "https://mazzucchellis.com.au/collections/gifts",
        label: "GIFTS"
      },
      {
        id: 8,
        path: "https://mazzucchellis.com.au/",
        label: "EXPLORE"
      }
    ],
