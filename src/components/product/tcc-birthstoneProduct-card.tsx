...
const TccBirthstoneProductCard: FC<ProductProps> = ({
    product,
    className = "",
    contactClassName = "",
    ...
    const imageOne = "/assets/images/products/pendet.png";
    const imageTwo = "/assets/images/products/pendet-2.png";
    const imageThree = "/assets/images/products/ring.png";
    ...
    return (
        ...
        >
            ...
            >
                <Link
                    href={`${ROUTES.TCCBIRTHSTONE}/${product.slug}`}
            ...
            >
                ...
                <Link
                    href={{
                        pathname: `${ROUTES.TCCBIRTHSTONE}/${product.slug}`,
                    }}
...
export default TccBirthstoneProductCard;
