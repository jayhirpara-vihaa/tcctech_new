...
const ProductBirthStone3DRenderLocal2: React.FC = () => {
    ...
    const setViewerControls = async () => {
        ...
        await manager.addFromPath("/assets/VM-PD-R-33322.glb", options);
            ...
            <div className="grid lg:grid-cols-6 grid-cols-0 md:grid-cols-0 flex flex-wrap">
                                        ...
                                        <div id="price_id " className="px-5 pl-0">
                                            <div className="">
                                                <p className="text_size_16 font-bold pb-4 mt-5">
                                                    ...
                                                    >
                                                        ${`${parseInt(metalData ? metalData.price : 0) + parseInt(gemStoneOne ? gemStoneOne.price : 0) + parseInt(gemStoneTwo ? gemStoneTwo.price : 0) + parseInt(gemStoneThree ? gemStoneThree.price : 0) + parseInt(gemStoneFour ? gemStoneFour.price : 0) + parseInt(gemStoneFives ? gemStoneFives.price : 0)}`}
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                ...
                <div className="lg:col-span-2 col-span-2 lg:pl-[15px] pe-0 lg:mt-[35px]">
                    <div className="lg:visible invisible md:invisible">
                        <h1 className="mt-[6px] text-black feijoa-bold product-title">Birthstone</h1>
                        ...
                        <p className="font-semibold text-black mt-2 mb-2 feijoa birthtone-tab-font">

                            <span
                                className="birthtone-tab-font text-black feijoa "
                            >
                                ${`${parseInt(metalData ? metalData.price : 0) + parseInt(gemStoneOne ? gemStoneOne.price : 0) + parseInt(gemStoneTwo ? gemStoneTwo.price : 0) + parseInt(gemStoneThree ? gemStoneThree.price : 0) + parseInt(gemStoneFour ? gemStoneFour.price : 0) + parseInt(gemStoneFives ? gemStoneFives.price : 0)}`}
                            </span>
                        </p>
                            ...
                            {tabs.map((tab, index) => (
                                <button
                                    ...
                                    className={`${activeTab === index ? 'border-b-2 border-gray-500 text-[#CF025C]' : ''
                                        }  py-2 px-4 mx-1 focus:outline-none birthtone-tab-font text-black feijoa`}
                                >
                                    {tab.label}
                                </button>
                            ))}
...
export default ProductBirthStone3DRenderLocal2;