...
export const siteSettingsData = {
  ...
  site_header: {
    menu: [
      {
        id: 1,
        path: "/products/?filter=menu&value=menu-engagement-rings",
      ...
      {
        id: 2,
        path: "/products/?filter=menu&value=menu-wedding-ring",
      ...
      {
        id: 3,
        path: "/products/?filter=menu&value=menu-lifestyle-jewellery",
      ...
      {
        id: 4,
        path: "/products/?filter=menu&value=gents-jewellery",
