...
const EnternitybandProductCard: FC<ProductProps> = ({
    product,
    className = "",
    contactClassName = "",
    ...
    return (
        ...
        >
            ...
            >
                <Link
                    href={`${ROUTES.ENTERNITYBAND}/${product.slug}`}
            ...
            >
                ...
                <Link
                    href={{
                        pathname: `${ROUTES.ENTERNITYBAND}/${product.slug}`,
                    }}
...
export default EnternitybandProductCard;
