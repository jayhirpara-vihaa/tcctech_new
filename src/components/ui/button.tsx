...
import React, { forwardRef, ButtonHTMLAttributes, useContext } from "react";
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    ...
    {
      "": !disableBorderRadius,
      "bg-buttonColor text-white px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 hover:text-white  hover:shadow-cart":
        variant === "flat",
      "h-11 md:h-12 px-5 bg-buttonColor text-white py-2 transform-none normal-case hover:text-white  hover:shadow-cart":
        variant === "slim",
      "h-11 md:h-12 px-5 bg-buttonColor text- py-2 transform-none normal-case hover:":
        variant === "smoke",
