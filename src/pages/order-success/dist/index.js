...
var order_success_1 = require("@components/order/order-success");
...
function Order() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flex items-center justify-center mt-10 pb-0.5 mb-2 md:mb-5 lg:mb-6 2xl:mb-7 3xl:mb-8" },
            React.createElement(text_1["default"], { className: "Tcc-text-our-Jewelry-Section" }, t("text-order-success"))),
        React.createElement(container_1["default"], null,
            React.createElement(order_success_1["default"], null))));
}
exports["default"] = Order;
Order.Layout = layout_three_1["default"];
