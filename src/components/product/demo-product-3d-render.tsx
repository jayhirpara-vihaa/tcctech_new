...
const DemoProduct3DRender: React.FC<{ configData: any }> = (props) => {
  ...
  const arrShankNumbers1 = [
    { key: "SH-PL-UM", value: "16246" },
    { key: "SH-PL-PL", value: "16300" },
  ];

  const arrHeadNumbers1 = [
    { key: "HD-SH-OV-1.00", value: "15495" },
    { key: "HD-SH-RD-1.00", value: "15488" },
    { key: "HD-SH-EM-1.00", value: "15502" },
    { key: "HD-HH-RD-1.00", value: "15453" },
    { key: "HD-HH-OV-1.00", value: "15460" },
    { key: "HD-HH-EM-1.00", value: "15467" },
  ];
  ...
  const refreshUI = async () => {
    ...
    if (viewer) {
      ...
      // let finalHeadName1 = "HD-" + headName;
      // let finalShankName1 = "SH-" + shankName;
      // const findHeadDesign1 = arrHeadNumbers1.filter((t: any) => t.key == finalHeadName1);
      // console.log("findHeadDesign1", findHeadDesign1)
      // const finalShankDesign1 = arrShankNumbers1.filter(
      //   (t: any) => t.key == finalShankName1
      // );

      // const options = { autoScale: false, autoCenter: false, useRgbm: true };

      // if (findHeadDesign1.length > 0) {
      //   const arrHeadDesignNumber = findHeadDesign1[0].value;
      //   console.log("arrHeadDesignNumber", arrHeadDesignNumber)
      //   const headFileName = finalHeadName1 + "-" + arrHeadDesignNumber + ".glb";
      //   await viewer
      //     .getManager().addFromPath("https://tcctech-staging.s3.ap-south-1.amazonaws.com/webgi/" + headFileName, options);
      // }
      // if (finalShankDesign1.length > 0) {
      //   const arrShankDesignNumber = finalShankDesign1[0].value
      //   const shankFileName = finalShankName1 + "-" + arrShankDesignNumber + ".glb";
      //   await viewer
      //     .getManager().addFromPath("https://tcctech-staging.s3.ap-south-1.amazonaws.com/webgi/" + shankFileName, options);
      // }
  ...
  const handle360Image = async () => {
    ...
    // viewer.scene.modelRoot.rotation.z = 1.57;
    // viewer.scene.modelRoot.rotation.x = 1.57;
            ...
            <div className="pb-7 tcc-mobile-margin">
              <div className="flex">
                <h2 className="text-black mb-3.5 TCC-product-detail-heading pt-3">
                  Engagement Ring{" "}
                  <small className="flex w-100 text-heading">TCC-100007</small>
                </h2>
              </div>
