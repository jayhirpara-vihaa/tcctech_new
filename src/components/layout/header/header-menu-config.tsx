      ...
      {data?.map((item: any) => (
        ...
        >
          <Link
            href={""}
            className={
              `uppercase relative inline-flex items-center px-3 py-0 pt-0 text-sm font-normal xl:text-base text-headerTextColor xl:px-4 hover:text-[${companyInfo && companyInfo.web_secondary_color
              }] ` +
