...
import BirthstoneProductCard from "./birthstoneProduct-card";
import DATA from "../../../public/api/enternity-bands.json";
import EnternitybandProductCard from "./enternitybands-product-card";

interface ProductGridProps {
    className?: string;
}
export const EnternityBandsProductGrid: FC<ProductGridProps> = ({ className = "" }) => {
