...
const Carousel: React.FunctionComponent<CarouselPropsType> = ({
  ...
  let nextButtonClassName = cn(
    "w-7 h-7 lg:w-8 lg:h-8 text-sm md:text-base lg:text-lg text-black flex items-center justify-center rounded absolute transition duration-250 hover:bg-gray-900 hover:text-white focus:outline-none transform shadow-navigation translate-x-1/2",
    {
