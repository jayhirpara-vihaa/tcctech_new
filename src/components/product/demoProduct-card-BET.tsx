...
const DemoProductCardBET: FC<ProductProps> = ({
  product,
  className = "",
  contactClassName = "",
    ...
    if (variant === "grid") {
      return (
        <div id={product.id}>
          <Image
            onClick={s}
            src={product?.image_path ? `${product.image_path}` : defaultImage}
            ...
            className={cn(
              `object-cover bg-gray-100/40 ${!disableBorderRadius && ""}`,
              {
          ...
          />
          {variant === "grid" && (
            <div className="absolute end-3 sm:end-2 top-2 space-y-3 w-auto cursor-pointer z-10">
            ...
            className={cn(
              `object-cover bg-gray-100/40 ${!disableBorderRadius && ""}`,
              {
                ...
                "rounded-md transition duration-150 ease-linear transform group-hover:scale-105":
                  variant === "gridSlim",
                " transition duration-200 ease-linear transform group-hover:scale-105":
                  variant === "list",
              }
            )}
          />
  ...
  console.log(ROUTES.DEMOPRODUCTBET)
  return (
    <div
      key={product.id}
      className={cn(
        ...
        {
          "flex-col items-start transition duration-200 ease-in-out transform hover:-translate-y-1 md:hover:-translate-y-1.5 hover:shadow-product":
            variant === "gridModern" ||
            variant === "gridModernWide" ||
            variant === "gridTrendy",
          "flex-col items-start transition duration-200 ease-in-out transform ":
            variant === "grid",
          " bg-white":
            (variant === "grid" && !bgGray) ||
          ...
          "flex-col items-start": variant === "gridSlim",
          "items-center transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-listProduct":
            variant === "listSmall",
          "flex-row items-center transition-transform ease-linear":
            variant === "list",
    ...
    >
      ...
      >
        <Link
          href={`/demo-product-BET/${product.slug}`}
          as={`demostoneproducts/slug/`}
      ...
      >
              ...
              return (
                ...
                >
                  <Image
                    ...
                    quality={100}
                    className={cn(
                      ` object-cover bg-gray-100/40 mr-3 ${!disableBorderRadius && " "
                      }`,
                      {
                        "w-full transition duration-200 ease-in ":
                          variant === "grid",
        ...
        <Link
          href={{
            pathname: `/demo-product-BET/${product.slug}`,
          }}
        ...
        >
          ...
          >
            {variant === "grid" ? (
              <span
                className={`text-black hover:text-[#0D6363] BET-Product-card-title`}
              >
                {selectedTitle}
              </span>
            ) : (
        ...
        <div
          ...
          ${variant === "gridModern" ||
              ...
              : ""
            } ${bgTransparent ? "text-white" : "font-light"}`}
        >
...
export default DemoProductCardBET;
