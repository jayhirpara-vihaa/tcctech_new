...
var DemoProduct3DRender = dynamic_1["default"](function () { return Promise.resolve().then(function () { return require("@components/product/demo-product-3d-render-price"); }); }, {
    ssr: false,
    loading: function () { return React.createElement("p", null); }
});
function Product2() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(container_1["default"], null, configData && (React.createElement(DemoProduct3DRender, { configData: configData && configData.data })))));
}
