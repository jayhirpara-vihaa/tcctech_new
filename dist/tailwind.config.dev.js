  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Change This for Header background Color
        footerColor: "blue",
        // Change This for Footer background Color
        megaMenuColor: "white",
        // Change This for Mega Color
        headerTextColor: "white",
        // Change This for Header Primary text Color
        headerSecondaryTextColor: "#DBB961",
        // Change This for Header Secondary text Color
        secondaryColor: "#DBB961",
        mobileNavigationIconColor: "black",
        // Change This for Mobile Navigation Icon
        primary: "#FBF1E9",
        TCCprimary: "#E58A1F",
        body: "#5A5A5A",
        heading: "#dbb961",
