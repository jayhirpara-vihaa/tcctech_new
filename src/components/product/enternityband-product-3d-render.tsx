...
const ProductEnternityBand3DRenderLocal: React.FC = () => {
                        ...
                        >
                            ...
                            {centerDiamond?.sort_code == "G" && (
                                <div>
                                    ...
                                    <span className="" style={{ background: `${webConfigBgColor}`, backgroundClip: "text", WebkitTextFillColor: "transparent", WebkitBackgroundClip: "text" }}>{diamondCut.name}</span>
                                    <DiamondCutComponent
...
export default ProductEnternityBand3DRenderLocal;
